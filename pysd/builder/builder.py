...
# - Modify static functions (with no calls, exogenous variables, etc) to reference
# their own function attribute, instead of having it hardcoded in,
# so that when we have the function compiled, you can change the value without having to
# recompile with the jit.
...
class Builder(object):
    ...
    def add_stock(self, filename, identifier, expression, initial_condition):
    ...
    def add_flaux(self, filename, identifier, expression, doc=''):
