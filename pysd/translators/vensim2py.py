...
class TextParser(NodeVisitor):
    ...
    def visit_Stock(self, n, (Identifier, _1, eq, _2, integ, _3,
        ...
        self.builder.add_stock(self.filename, Identifier, expression, initial_condition)
        return Identifier


    def visit_Flaux(self, n, (Identifier, _1, eq, SNL, expression)):
        self.builder.add_flaux(self.filename, Identifier, expression)
        return Identifier


    def visit_Lookup(self, n, (Identifier, _1, lparen, _2, NL1, _3, Range,
                               _4, CopairList, _5, rparen)):
        self.builder.add_lookup(self.filename, Identifier, Range, CopairList)
        return Identifier
    ...
    def visit_ConCall(self, n, (ConKeyword, _1, lparen, _2, args, _4, rparen)):
        ...
        if ConKeyword == 'DELAY1': #DELAY3(Inflow, Delay)
            return self.builder.add_n_delay(self.filename, args[0], args[1], str(0), 1)
        elif ConKeyword == 'DELAY1I':
            pass
        elif ConKeyword == 'DELAY3':
            return self.builder.add_n_delay(self.filename, args[0], args[1], str(0), 3)
        elif ConKeyword == 'DELAY N':#DELAY N(Inflow, Delay, init, order)
            return self.builder.add_n_delay(self.filename, args[0], args[1], args[2], args[3])
            ...
            return self.builder.add_n_smooth(self.filename, args[0], args[1], args[2], 3)
            ...
            return self.builder.add_initial(self.filename, args[0])
